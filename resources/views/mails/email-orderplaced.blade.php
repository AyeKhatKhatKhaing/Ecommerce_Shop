    ...
    <div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; color: #1E1D1B;">
                            ...
                            @else
                                你好
                            @endif, <span style="font-weight: 700;">{{ $order->member ? $order->member->getFullName() : '' }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; font-weight: 600; color: #1E1D1B;">
                            @if ($order->lang_key == 'en')
                                Your order number
                            @elseif ($order->lang_key == 'hans')
                                您的订单号
                    ...
                    <tr>
                        <td style="padding: 0 36px 20px;">
                            <a type="button" href="{{ route('front.member.order-detail', $order->code)}}" class="email-button">
                                @if ($order->lang_key == 'en')
                                    Check Order Status
                                @elseif ($order->lang_key == 'hans')
                                    检查订单状态
                    ...
                    <tr>
                        <td style="padding: 0 36px; font-size: 16px; color: #1E1D1B;">
                            ...
                            @else
                                訂單號碼：
                            @endif
                            <span style="font-weight: 700;">{{ $order->code }}</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 36px; font-size: 16px; color: #1E1D1B;">
                            ...
                            @else
                                日期：
                            @endif
                            <span style="font-weight: 700;">{{ date('d/m/Y', strtotime($order->created_date)) }}</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 36px; font-size: 16px; color: #1E1D1B;">
                            ...
                            @else
                                地位：
                            @endif
                            <span style="font-weight: 700;">{{ $order->getOrderStatus($order->order_status) }}</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 36px; font-size: 16px; color: #1E1D1B;">
                            ...
                            @else
                                付款方式：
                            @endif
                            <span style="font-weight: 700;">{{ $order->getPaymentType() }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 36px; font-size: 16px; color: #1E1D1B;">
                            ...
                            <div style="max-height: 100px; overflow: auto;">
                                @foreach ($order->order_items as $item)
                                    <div style="display: flex;">
                                        <div>
                                            {{-- <img src="{{ asset(isset($item->product_datas) ? $item->product_datas['feature_image'] : '') }}" alt="" style="width: 71px; height: 71px;"> --}}
                                            <img src="{{ $message->embed(isset($item->product_datas) ? $item->product_datas['feature_image'] : '') }}" alt="" style="width: 79px; height: 91px;">
                                        </div>
        ...
        <div style="background-color: #54301A;max-width: 640px;margin: 0 auto;padding: 48px 0;text-align: center;">
            <table class="emailfooter-table">
                <tbody>
                    <tr>
                        <td style="font-weight: 600; padding: 0 30px 10px; font-size: 18px; color: white; text-align: center;">
                            @if ($order->lang_key == 'en')
                                Opening Hours
                            @elseif ($order->lang_key == 'hans')
                                营业时间
