                ...
                <tbody>
                    <tr>
                        <td style="text-align: center; padding-top: 50px; padding-bottom: 20px;">
                            <img src="{{ $message->embed('frontend/img/email-subscribe.png') }}" alt="">
                        </td>
                    </tr>
                    <tr>
                        <td
                            style="text-align: center; font-size: 18px; font-weight: 600; color: #54301A; padding-bottom: 36px;">
                            {{ __('frontend.mail.thank_for_subscribing') }}
                        </td>
                    </tr>
                    <tr>
                        @php
                        ...
                        <td style="padding: 0 36px 20px; font-size: 16px; color: #1E1D1B;">
                            Hello, <span style="font-weight: 700;">{{ $name[0] }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; color: #1E1D1B;"> {{ __('frontend.mail.subscribed_newsletter') }}</td>
                    </tr>
