                ...
                <tbody>
                    <tr>
                        <td style="text-align: center; padding-top: 50px; padding-bottom: 20px;">
                            <img src="{{ $message->embed('frontend/img/email-psw.png') }}" alt="">
                        </td>
                    </tr>
                    <tr>
                        <td
                            style="text-align: center; font-size: 18px; font-weight: 600; color: #54301A; padding-bottom: 36px;">
                            {{ __('frontend.mail.password_reset_request') }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; font-weight: 600; color: #1E1D1B;"> {{ __('frontend.mail.reset_your_password') }}</td>
                    </tr>


                    <tr>
                        <td style="padding: 0 36px 20px;">
                            <a href="{{ route('front.reset.password', ['type' => $member->email, 'token' => $token]) }}" class="email-button"> {{ __('frontend.mail.click_reset_password') }}</a>
                        </td>
                    </tr>
