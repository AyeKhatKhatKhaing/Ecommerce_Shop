                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; font-weight: 600; color: #1E1D1B;">
                            {{ __('frontend.mail.supporting') }}
                            @if($coupon->discount_type == 'percentage')
                            {{ $coupon->amount}} %
                            @else
                            HK$ {{ $coupon->amount}}
                            @endif
                            {{ __('frontend.mail.next_purchase') }}</td>
                    </tr>

                    <tr>
                        <td
                            style="padding: 0 36px 20px; font-size: 22px; font-weight: 700; text-align: center; color: #54301A;">
                            {{ $coupon->code ?? '' }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 36px 20px;">
                            <a href="{{ route('front.home') }}" type="button" class="email-button">{{ __('frontend.mail.use_coupon_now') }}</a>
                        </td>
                    </tr>
