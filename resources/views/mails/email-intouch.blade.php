                ...
                <tbody>
                    <tr>
                        <td style="text-align: center; padding-top: 50px; padding-bottom: 20px;">
                            <img src="{{ $message->embed('frontend/img/email-intouch.png') }}" alt="">
                        </td>
                    </tr>
                    <tr>
                        <td
                            style="text-align: center; font-size: 18px; font-weight: 600; color: #54301A; padding-bottom: 36px;">
                            {{ __('frontend.mail.getting_in_touch') }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; color: #1E1D1B;">
                            {{ __('frontend.mail.hello') }}, <span style="font-weight: 700;">{{ isset($member) ? $member->full_name : '' }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; color: #1E1D1B;"> {{ __('frontend.mail.contacting_us') }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 0 36px 20px; font-size: 16px; color: #1E1D1B;"> {{ __('frontend.mail.nice_day') }}</td>
                    </tr>
