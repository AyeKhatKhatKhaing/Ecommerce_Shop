                ...
                <div class="card">
                    <div class="card-header border-0"> 
                        ...
                        <div class="card-toolbar">
                            <a href="{{ url('/admin/permissions/create') }}" class="btn btn-primary " title="Add New User">
                                <i class="bi bi-plus-lg"></i> {{ __('backend.common.add_new') }}
                            </a>
                        </div>
                    </div>
                    <form method="get" action="{{ route('permissions.index') }}" id="permission-form" class="filter-clear-form">
                        <div class="card-header border-0">
                    ...
                    <div class="card-body">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    @foreach($permissions as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/admin/permissions/' . $item->id . '/edit') }}" title="Edit User">
                                                ...
                                                <form method="POST" action="{{ url('/admin/permissions', $item->id) }}" class="deleteForm" style="display: inline;">                
                        ...
                        <div class="row my-3">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
                                {{ Admin::tableLength($permissions) }}
                            </div>
                            <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
                                <div class="pagination-wrapper"> {!! $permissions->appends([
