<div class="row">
    <div class="col-md-8">
        <h2 class="fs-1">@if($formMode == "edit") {{ __('backend.common.edit') }} @else {{ __('backend.common.create') }} @endif {{ __('backend.sidebar.contact_page') }}</h2>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="float-left">
                    ...
                    <button type="button" class="btn btn-secondary cancel" onclick="window.location='{{ url('/admin/contact-page') }}'"><i class="bi bi-x"
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('banner_title_'.$lng) ? 'has-error' : ''}}">
                                    @foreach (config('locale.langs_code') as $key => $code)
                                        @if ($lng == $key)
                                            {!! Form::label('banner_title_'.$lng, __('backend.contact.banner_title').'('.$code.')', ['class' => 'control-label mb-3 required']) !!}
                                        @endif
                                    @endforeach
                                    {!! Form::text('banner_title_'.$lng, isset($contactpage) && isset($contactpage->banner_titles) ? $contactpage->banner_titles[$lng] : null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group{{ $errors->has('meta_title_'.$lng) ? 'has-error' : ''}}">
                                                    @foreach (config('locale.langs_code') as $key => $code)
                                                        ...
                                                        @endif
                                                    @endforeach
                                                    {!! Form::text('meta_title_'.$lng, isset($contactpage) && isset($contactpage->meta_titles) ? $contactpage->meta_titles[$lng] : null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group{{ $errors->has('meta_description_'.$lng) ? 'has-error' : ''}}">
                                                    @foreach (config('locale.langs_code') as $key => $code)
                                                        ...
                                                        @endif
                                                    @endforeach
                                                    {!! Form::textarea('meta_description_'.$lng, isset($contactpage) && isset($contactpage->meta_descriptions) ? $contactpage->meta_descriptions[$lng] : null, ('' == 'required') ? ['class' => 'form-control h-150px', 'required' => 'required'] : ['class' => 'form-control h-150px']) !!}
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="panel-block">
                                                    ...
                                                    <div id="holder-meta-image">
                                                            @if(!empty($contactpage->meta_image))
                                                                <div class='lfmimage-container meta-imagelfmc0'>
                                                                    <img src="{{ asset($contactpage->meta_image) }}" class='lfmimage w-100' style="height: 20rem;">
                                                                    <div>
                                                    ...
                                                    <div class="input-group mt-3">
                                                            ...
                                                            <input id="meta-image" class="form-control" type="text" name="meta_image" value="{{isset($contactpage) ? $contactpage->meta_image : ''}}">
                                                    </div>  
                                                    </div>
                                                </div>
                                                <div class="row mt-4">
                ...
                <div class="panel-block">
                    <div class="form-group">
                       <div id="holder-banner-image">
                            @if(!empty($contactpage->banner_image))
                                <div class='lfmimage-container banner-imagelfmc0'>
                                    <img src="{{ asset($contactpage->banner_image) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                       ...
                       <div class="input-group mt-3">
                            ...
                            <input id="banner-image" class="form-control" type="text" name="banner_image" value="{{isset($contactpage) ? $contactpage->banner_image : ''}}">
                       </div>  
                    </div>
                </div>
                <div class="row mt-4">
