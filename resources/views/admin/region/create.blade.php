...
@section('content')
<div class="container">
    {!! Form::open(['url' => '/admin/regions', 'class' => 'form-horizontal', 'files' => true, 'id' => "kt_docs_formvalidation_text"]) !!}
    <div class="row mx-1">
        @if ($errors->any())
    ...
    <div class="row">
        @include('admin.region.form', ['formMode' => 'create' , 'countries' => $countries])
    </div>
    <div class="row mt-4">
