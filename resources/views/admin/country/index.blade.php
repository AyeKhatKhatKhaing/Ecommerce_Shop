            ...
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ url('/admin/countries/create') }}" class="btn btn-primary btn-hover me-2" title="Add New Country">
                            <i class="fa fa-plus" aria-hidden="true"></i> {{ __('backend.common.add_new') }}
                        </a>
                    </div>
                </div>
                <form method="get" action="{{ route('countries.index') }}" id="country-form" class="filter-clear-form">
                    <div class="card-header border-0">
                ...
                <div class="card-body pt-0">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" id="switcher_checkbox_{{ $item->id }}"
                                                type="checkbox" onclick="statusChange({{ $item->id }}, '/admin/countries/status-change')"
                                                name="status{{ $item->id }}"
                                                {{ $item->status ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                    ...
                                    <td class="sticky text-center">
                                        <a href="{{ url('/admin/countries/' . $item->id . '/edit') }}" title="Edit MemberType">
                    ...
                    <div class="row my-3">
                        <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
                            {{ Admin::tableLength($countries) }}
                        </div>
                        <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
                            <div class="pagination-wrapper"> {!! $countries->appends([
