...
@section('breadcrumb-info', __('backend.user.user_list'))
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="get" action="{{ route('users.index') }}" id="users-form" class="filter-clear-form">
                        <div class="card-header border-0">
                                    ...
                                    @foreach($users as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{ url('/admin/users', $item->id) }}" class="deleteForm" style="display: inline;">                
