        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="get" action="{{ url('/admin/order?type=hk') }}" id="hk-order-form" class="filter-clear-form">
                                    ...
                                    @foreach($orders as $item)
                                        <tr>
                                            ...
                                            <td class="sticky text-center">
                                                ...
                                                <a href="{{ url('admin/order/'.$item->id.'?type=hk') }}" title="View Order Details">
