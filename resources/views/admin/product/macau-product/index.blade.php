        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- end:Modal -->
                    <form method="get" action="{{ url('/admin/product?type=ma') }}" id="macau-form" class="filter-clear-form">
                        <div class="card-header border-0"> 
                            <h3 class="card-title">
                                {{ __('backend.products.macau_product') }}
                            </h3>
                            <div class="card-toolbar">
                                ...
                                <a href="{{ url('/admin/product/create?type=ma') }}" class="btn btn-primary " title="Add New User">
                                    ...
                                    @foreach($products as $item)
                                        <tr>
                                            ...
                                            <td class="sticky text-center">
                                                <a href="{{ url('/admin/product/' . $item->id . '/edit?type=ma') }}" title="Edit Hong Kong Product">
