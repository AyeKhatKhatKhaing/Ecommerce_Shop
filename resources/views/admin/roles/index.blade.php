                ...
                <div class="card">
                    <div class="card-header border-0"> 
                        ...
                        <div class="card-toolbar">
                            <a href="{{ url('/admin/roles/create') }}" class="btn btn-primary " title="Add New Role">
                                <i class="bi bi-plus-lg"></i> {{ __('backend.common.add_new') }}
                            </a>
                        </div>
                    </div>
                    <form method="get" action="{{ route('roles.index') }}" id="role-form" class="filter-clear-form">
                        <div class="card-header border-0">
                    ...
                    <div class="card-body">
                                    ...
                                    @foreach($roles as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{ url('/admin/roles', $item->id) }}" class="deleteForm" style="display: inline;">                
                        ...
                        <div class="row my-3">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
                                {{ Admin::tableLength($roles) }}
                            </div>
                            <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
                                <div class="pagination-wrapper"> {!! $roles->appends([
